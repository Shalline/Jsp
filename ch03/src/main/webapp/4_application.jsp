...
<html>
	...
	<body>
		...
		<p>
			...
			sevlet 버전 : <%= application.getMajorVersion() %>
		...
		<h4>자원정보</h4>
		<p>
			현재 파일(4_application.jsp) 전체 시스템 종료<br/>
			<%= application.getRealPath("./4_application.jsp") %>
		</p>
		<!-- C:\Users\GGG\Desktop\work_space\jsp\.metadata\.plugins\
		org.eclipse.wst.server.core\tmp0\wtpwebapps\ch03\
		4_application.jsp
